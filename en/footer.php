        ...
        <div class="container-fluid">
            <div class="row row-cols-1 row-cols-md-5 rtl">
                <div class="col text-center">
                    ...
                    <p style="width: 740px;margin-top: 30px;">Second Industrial Zone, Plot 165-166, New Noubaria, Beheira<br></p>
                </div>
                <div class="col text-center">
        ...
        <div class="container-fluid">
            <div class="row row-cols-1 rtl">
                <div class="col text-center"><a class="btn btn-outline-success btn-lg d-flex float-none justify-content-between" role="button" href="https://www.google.com/maps/place/30%C2%B039'30.3%22N+30%C2%B004'47.9%22E/@30.6584167,30.0821505,17z/data=!3m1!4b1!4m5!3m4!1s0x0:0x0!8m2!3d30.6584167!4d30.0799618?hl=ar&amp;shorturl=1"
                        style="width: 240px;" target="_blank"><span style="flex: 1;">Get directions</span><span><i class="fa fa-location-arrow"></i></span></a></div>
 ...
 <path fill-rule="evenodd" clip-rule="evenodd" fill="#1A171B" d="M9.672,10.243l1.5,2.192l-4.051,5.586
    		c-0.697-0.371-1.076-1.432-0.644-2.183L9.672,10.243z"></path> 
                ...
                <div class="col text-right p-0" style="padding-top: 15px;">
                    <p class="text-center text-md-right small copyrights" style="color: #fff;">Growth Chem for Advanced Chemicals&nbsp;©<span class="current-year"><?php echo date("Y"); ?></span>
                    </p>
                </div>
            </div>
        </div>
